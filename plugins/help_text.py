    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/ShadowsArena'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/ShadowsArena')
                ],
                [
                    InlineKeyboardButton('ᴅᴇᴠᴏʟᴏᴘᴇʀ', url='https://t.me/ShadowKing9o'),
                    InlineKeyboardButton('sᴏᴜʀᴄᴇ', url='https://github.com/MasterShad0w/Shadow-File-Renamer-Bot')
                ]
            ]
        ),
